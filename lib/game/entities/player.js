...
.defines(function(){
    EntityPlayer = ig.Entity.extend({
        animSheet: new ig.AnimationSheet( 'media/karemy.png', 16, 16 ),
        size: {x: 8, y:14},
        offset: {x: 4, y: 2},
        flip: false,
        maxVel: {x: 100, y: 150},
   ...
   EntityBullet = ig.Entity.extend({
        ...
        animSheet: new ig.AnimationSheet( 'media/icecream.png', 10, 10 ),
        maxVel: {x: 180, y: 0},
    ...
    EntityGrenade = ig.Entity.extend({
        size: {x: 4, y: 4},
        offset: {x: 2, y: 2},
        animSheet: new ig.AnimationSheet( 'media/taco.png', 10, 10 ),
        type: ig.Entity.TYPE.NONE,
